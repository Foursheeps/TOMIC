...
from datmp.model.adda import ExprModelConfig, MLPModelConfig, NameModelConfig, PatchModelConfig
from datmp.train.adda.train import main as train_adda_func
