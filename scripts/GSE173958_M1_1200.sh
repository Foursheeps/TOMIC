#!/bin/bash
# Script to run GSE173958 dataset training
# Example: bash run_GSE173958.sh
...
# ==========================================
DATA_PROCESS_SCRIPT=/your/path/to/TOMIC/process_data/process_GSE173958.py
...
RAW_DATA_DIR=/your/path/to/raw_data/GSE173958_RAW
N_HIGHLY_VARIABLE_GENES=1200
OVERWRITE_DATA=0


DATA_FILE_NAME=GSE173958_${USE_BATCH}_${N_HIGHLY_VARIABLE_GENES}

# Update the data path and copy this file to new data path
NEW_DATA_PATH=${DATA_PATH}/${DATA_FILE_NAME}
DEFAULT_ROOT_DIR_BASE=${DATA_PATH}/outputs_GSE173958_${USE_BATCH}_${N_HIGHLY_VARIABLE_GENES}
...
# Can be customized based on batch type
RUN_ADDA=0
RUN_DANN=0
RUN_DSN=1
RUN_USUAL=1
...
# ==========================================
# Step 1: Process GSE173958 data
# ==========================================
echo "Step 1: Processing GSE173958 $USE_BATCH data..."
