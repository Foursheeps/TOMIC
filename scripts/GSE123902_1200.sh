#!/bin/bash
# Script to run GSE123902 dataset training
# Example: bash 94_run_all(GSE123902).sh
...
# ==========================================
DATA_PROCESS_SCRIPT=/your/path/to/TOMIC/process_data/process_GSE123902.py
...
# ==========================================
RAW_DATA_DIR=/your/path/to/raw/data/GSE123902_RAW
N_HIGHLY_VARIABLE_GENES=1200
OVERWRITE_DATA=0

DATA_FILE_NAME=GSE123902_${N_HIGHLY_VARIABLE_GENES}

# Update the data path and copy this file to new data path
NEW_DATA_PATH=${DATA_PATH}/${DATA_FILE_NAME}
DEFAULT_ROOT_DIR_BASE=${DATA_PATH}/outputs_GSE123902_${N_HIGHLY_VARIABLE_GENES}
...
# ==========================================
# Step 1: Process GSE123902 data
# ==========================================
echo "Step 1: Processing GSE123902 data..."
