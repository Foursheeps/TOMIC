...
"""
Lightning Module for Adversarial Discriminative Domain Adaptation with Token-based Transformer.
...
class LightningModule(BaseLightningModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.source_encoder = NameTransformerEncoder(
            seq_len=seq_len,
    ...
    def _extract_discriminator_features(self, features: torch.Tensor) -> torch.Tensor:
        """Extract features for discriminator for name model."""
        # Transformer models output (batch_size, seq_len+2, hidden_size)
