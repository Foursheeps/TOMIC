"""
Training configuration classes for DANN training scripts.
...
class TrainerConfig:
    ...
    def __init__(
        ...
        mode: str = "max",
        save_top_k: int = 2,
        gamma: float = 0.1,  # DANN loss weight (domain adversarial loss)
        ...
        **kwargs,
        ...
        # Loss function weights (Domain Adversarial Neural Network)
