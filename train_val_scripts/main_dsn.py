...
def train(
    ...
    Args:
        model_type: Model type to train ("mlp", "patch", "expr", "name", f"dual_{bingings}")
    ...
    """
    models = {
        "mlp": MLPModelConfig4DSN(**base_model_args, **mlp_model_args),
        "patch": PatchTransformerModelConfig4DSN(**base_model_args, **transformer_model_args),
        "expr": ExprTransformerModelConfig4DSN(**base_model_args, **transformer_model_args),
        "name": NameTransformerModelConfig4DSN(**base_model_args, **transformer_model_args),
        "dual": DualTransformerModelConfig4DSN(**base_model_args, **dual_model_args),
    }
    print(f"model_type: {model_type}")
    print(f"models[model_type]: {models[model_type]}")
...
def arg_parser():
    ...
    parser = ArgumentParser(description="Train DSN models", allow_abbrev=False)
