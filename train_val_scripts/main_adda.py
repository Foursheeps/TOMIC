...
from datmp.train.adda.train import main as train_func
from datmp.train.adda.train_config import TrainerConfig
...
def arg_parser():
    ...
    parser = ArgumentParser(description="Train ADDA models", allow_abbrev=False)
    ...
    # ADDA-specific configuration
    parser.add_argument("--pretrain_patience", type=int, default=None)
    parser.add_argument("--pretrain_monitor_metric", type=str, default="val/pretrain_accuracy")
    parser.add_argument("--pretrain_mode", type=str, default="max")
    parser.add_argument("--adversarial_patience", type=int, default=None)
    parser.add_argument("--adversarial_monitor_metric", type=str, default=None)
    parser.add_argument("--adversarial_mode", type=str, default=None)
