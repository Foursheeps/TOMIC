...
from ..encoder_decoder import PatchDecoder, PatchTransformerEncoder
from .base import BaseLightningModule

"""
Lightning Module for Domain Separation Networks with Patch-based Transformer.
...
class LightningModule(BaseLightningModule):
    ...
    - Reconstructs original input using PatchDecoder
    """
    ...
    def __init__(
        ...
        # Initialize decoder
        self.reconstructor = PatchDecoder(
            seq_len=seq_len,
            hidden_size=hidden_size,
            patch_size=patch_size,
            activation=activation,
